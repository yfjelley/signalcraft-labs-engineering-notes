# LinkedIn Profile and Post Drafts

These drafts can be used for a LinkedIn personal profile, company page, or post. Review and edit before publishing.
...
It includes a dry-run webhook de-duplication and risk-gate demo, API key permission guidance, platform notes for IBKR / Schwab / Alpaca / FIX workflows, and delivery acceptance checklists.
...
Add the GitHub repository and website as featured links:
